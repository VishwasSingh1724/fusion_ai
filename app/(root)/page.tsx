...
//       handlePageLoad();
//     } else {
//       // Listen for the `load` event if not fully loaded yet
...
//   // Show the loading screen until the entire page is loaded
//   if (!isLoaded) {
...
//   // Render the actual page when fully loaded
//   return (
...
//       <CTASection />
//       <HorizontalScroll/>
//       <div className="mb-[100vh]"> {/* Adds spacing to ensure scrolling happens for footer visibility */}
//         <PricingSection />
//       </div>

//       {/* Footer will stick to the bottom after scrolling */}
