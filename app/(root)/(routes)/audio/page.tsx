...
// import { FileAudio, SendHorizonal } from 'lucide-react';
...
//         if (data && Array.isArray(data) && data[0].file_url) {
//           setMusic(data[0].file_url); // Set the music URL from the response
//         } else {
//           setError('Failed to retrieve music URL');
//         }
//       } else {
...
//         icon={FileAudio}
//       />
//       <div className="flex items-center bg-slate-100 lg:w-[60%] w-[90%] rounded-lg shadow-lg flex-wrap pb-4 pt-4 md:p-0 gap-6 justify-between">
//         <input
//           value={prompt}
//           onChange={(e) => setPrompt(e.target.value)}
//           placeholder="Enter music prompt"
//           className="p-3 lg:p-4 w-[68%] m-3 bg-slate-100 rounded-md outline-none"
//         />
//         <button
//           onClick={setAudio}
//           className="mr-4 bg-slate-800/60 text-white text-lg p-2 rounded-md font-bold lg:p-3 shadow-md flex item-center gap-2 content-center m-2"
//         >
//           Send
//           <SendHorizonal />
//         </button>
...
const saveMusic = async() =>{
  ...
  //         setMusic(data.music[0].file_url); // Access the music URL correctly
  //       } else {
  //         setError('Failed to retrieve music URL');
  //       }
  //     } else {
