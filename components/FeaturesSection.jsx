...
//   // Scroll to section when it comes into view
//   useEffect(() => {
...
//         });
//       },
//       { threshold: 0.2 } // Start when 10% of the section is visible
//     );
...
//     <section 
//       ref={sectionRef}
//       className="relative bg-transparent min-h-screen w-full snap-start"
//     >
//       <div className="absolute inset-0 bg-gradient-to-b from-black to-purple-900" />
...
//         <motion.div
//           ref={containerRef}
//           className="h-[44rem] overflow-x-auto flex justify-center relative space-x-16 rounded-lg"
//         >
//           <div className="relative flex items-start px-4">
//             <div className="max-w-2xl">
//               {content.map((item, index) => (
//                 <div key={item.title + index} className="my-72">
//                   <motion.h3
//                     initial={{ opacity: 0 }}
//                     animate={{
//                       opacity: activeCard === index ? 1 : 0.4,
...
//             </div>
//           </div>
//           <div className="hidden lg:block sticky -top-9">
//             <div
//               className={cn(
//                 "h-[90vh] w-[650px] rounded-lg overflow-hidden z-40",
//                 contentClassName
//               )}
//             >
//               <WaveyImage
